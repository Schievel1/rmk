...
You need the bootymcbootface bootloader (included in the RMK repo under `bootymcbootface/`) in the **correct flash size** for your board. The available versions are named by flash size, e.g.:
