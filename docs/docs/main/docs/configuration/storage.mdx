...
Changing the RMK version, commit or features erases everything, BLE pairings included. Changing only your layout rewrites those items and keeps your pairings. See [Storage](/docs/features/storage) for the full table.
